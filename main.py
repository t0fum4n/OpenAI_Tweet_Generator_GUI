...
consumer_key_entry = tk.Entry(width=65)
...
consumer_secret_entry = tk.Entry(width=65)
...
access_token_entry = tk.Entry(width=65)
...
access_token_secret_entry = tk.Entry(width=65)
...
openai_key_entry = tk.Entry(width=65)
...
prompt_entry = tk.Entry(width=65)
prompt_entry.grid(row=5, column=1)

# "Run" button
run_button = tk.Button(text="Run", width=20, command=run_script)
